...
final class OfflinePaymentViewModelTests: XCTestCase {
    ...
    private func buildSUT() -> OfflinePaymentViewModel {
        ...
        given(stubBankApi.getDepositTypesString()) ~> .just("{\"statusCode\":\"\",\"errorMsg\":\"\",\"node\":\"1069e0061c30\",\"data\":[{\"depositTypeId\":0,\"depositTypeName\":\"Offline\",\"isFavorite\":false,\"depositLimitMaximum\":100.0,\"depositLimitMinimum\":50.0}]}")
        
        given(stubBankApi.getDepositOfflineBankAccounts()) ~> .just("{\"statusCode\":\"\",\"errorMsg\":\"\",\"node\":\"1069e0061c30\",\"data\":{\"paymentGroupPaymentCards\":{\"1\":{\"paymentTokenId\":\"TokenIDTokenIDTokenI\",\"bankId\":1,\"branch\":\"\",\"accountName\":\"12345678901234567890\",\"accountNumber\":\"test-Acc No.\"}}}}")
        
        given(stubBankApi.getBanks()) ~> .just("{\"statusCode\":\"\",\"errorMsg\":\"\",\"node\":\"1069e0061c30\",\"data\":[{\"bankId\":1,\"shortName\":\"ICBC\",\"name\":\"工商银行\"}]}")
