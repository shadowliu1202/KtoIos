...
final class CommonVerifyOtpViewControllerTest: XCTestCase {
    ...
    private func makeSUT(_ given: (CommonVerifyOtpViewController) -> ()) -> CommonVerifyOtpViewController {
        let storyboard = UIStoryboard(name: "Common", bundle: nil)
        let vc = storyboard.instantiateViewController(identifier: "CommonVerifyOtpViewController") as! CommonVerifyOtpViewController
    ...
    class CommonVerifyOtpArgsBuilder {
        ...
        var isHiddenCSBarItem: Bool = false
        var isHiddenBarTitle: Bool = false
        ...
        func create() -> CommonVerifyOtpArgs {
            return CommonVerifyOtpArgs(title: title, description: description, identityTip: identityTip, junkTip: junkTip, otpExeedSendLimitError: otpExeedSendLimitError, isHiddenCSBarItem: isHiddenCSBarItem, isHiddenBarTitle: isHiddenBarTitle, commonFailedType: commonFailedType)
        }
    }
}
