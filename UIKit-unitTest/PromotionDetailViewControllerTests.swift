...
final class PromotionDetailViewControllerTests: XCTestCase {
    ...
    private func getFakePromotionViewModel() -> PromotionViewModelMock {
        ...
        let fakeViewModel = mock(PromotionViewModel.self).initialize(promotionUseCase: dummyPromotionUseCase, playerUseCase: dummyPlayerUseCase)
    ...
    private func dummyTurnOverDetail() -> TurnOverDetail {
        TurnOverDetail(achieved: "0".toAccountCurrency(),
                       formula: "",
                       ...
                       parameters: .init(amount: "0".toAccountCurrency(),
    ...
    func test_manuallyUseCashBackCoupon_haveTurnOver_AlertTurnOverTip_KTO_TC_20() {
        ...
        given(stubPromotionViewModel.requestCouponApplication(bonusCoupon: any())) ~> .just(ConfirmBonusLocked(turnOver: self.dummyTurnOverDetail()))
    ...
    func test_manuallyUseCashBackCoupon_couponExpired_AlertExpiredTip_KTO_TC_21() {
        ...
        verify(mockUseCouponPresenter.showAlert(
