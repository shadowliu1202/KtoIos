...
public struct AllowPopToRoot: ViewModifier {
    ...
    public func body(content: Content) -> some View {
        content
            .introspect(.navigationView(style: .stack), on: .iOS(.v15, .v16, .v17, .v18), customize: { nv in
            ...
            .environment(\.popToRoot, PopToRoot(action: {
                nvManager.wrappedValue.popToRoot(tag: tag)
            }))
    }
}
...
struct PopToRootKey: EnvironmentKey {
    static var defaultValue: PopToRoot = PopToRoot {}
}
...
public extension View {
    func navigationViewManager(for tag: String = "root", afterBackDo cleanAction: @escaping () -> Void = {}) -> some View {
