...
class AccountMask {
    ...
    static private func maskEmail(account: String) -> String {
    ...
    static private func maskPhone(account: String) -> String {
    ...
    static private func getAccountType(account: String) -> AccountType {
        if account.contains("@") {
            return .email
        } else {
            return .phone
