...
extension ObservableType {
    ...
    /// Provides an unretained, safe to use (i.e. not implicitly unwrapped), reference to an object along with the events emitted
    /// by
    /// the sequence.
    ///
    ...
    /// sequence.
    /// - returns: An observable sequence that contains the result of `resultSelector` being called with an unretained reference
    /// on
