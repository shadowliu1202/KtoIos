...
class ImagePickerCollectionViewCell: UICollectionViewCell {
    ...
    private func addOverlay(_ animated: Bool) {
        ...
        overlayImageView.image = selectionImage ?? UIImage(named: "iconPhotoSelected32", in: Bundle.podBundle(forClass: type(of: self).self), compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
        overlayImageView.tintColor = selectionImageTintColor
