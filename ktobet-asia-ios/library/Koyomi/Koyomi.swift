...
// MARK: - KoyomiDelegate -
@objc
public protocol KoyomiDelegate: AnyObject {
  ...
  @objc
  optional func koyomi(_ koyomi: Koyomi, shouldSelectDates date: Date?, to toDate: Date?, withPeriodLength length: Int)
    -> Bool
  ...
  @objc
  optional func koyomi(_ koyomi: Koyomi, selectionTextColorForItemAt indexPath: IndexPath, date: Date) -> UIColor?
  ...
  @objc
  optional func koyomi(_ koyomi: Koyomi, fontForItemAt indexPath: IndexPath, date: Date) -> UIFont?
}
...
public enum KoyomiStyle {
  ...
  public typealias CustomColorScheme = (
    dayBackgrond: UIColor,
  ...
  var colors: Koyomi.Colors {
    switch self {
    // Basic color style
    case .monotone: return .init(
        dayBackgrond: .white,
        weekBackgrond: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray))
    case .standard: return .init(
        dayBackgrond: .white,
        weekBackgrond: .white,
        holiday: (UIColor.KoyomiColor.blue, UIColor.KoyomiColor.red))
    case .red: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.red,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.red)
    case .orange: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.orange,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.orange)
    case .yellow: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.yellow,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.yellow)
    case .tealBlue: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.tealBlue,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.tealBlue)
    case .blue: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.blue,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.blue)
    case .purple: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.purple,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.purple)
    case .green: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.green,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.green)
    case .pink: return .init(
        dayBackgrond: .white,
        weekBackgrond: UIColor.KoyomiColor.pink,
        week: .white,
        holiday: (UIColor.KoyomiColor.darkGray, UIColor.KoyomiColor.darkGray),
        separator: UIColor.KoyomiColor.pink)

    // Deep color style
    case .deepBlack: return .init(
        dayBackgrond: UIColor.KoyomiColor.black,
        weekBackgrond: UIColor.KoyomiColor.black,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.darkBlack)
    case .deepRed: return .init(
        dayBackgrond: UIColor.KoyomiColor.red,
        weekBackgrond: UIColor.KoyomiColor.red,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.orange)
    case .deepOrange: return .init(
        dayBackgrond: UIColor.KoyomiColor.orange,
        weekBackgrond: UIColor.KoyomiColor.orange,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.yellow)
    case .deepYellow: return .init(
        dayBackgrond: UIColor.KoyomiColor.yellow,
        weekBackgrond: UIColor.KoyomiColor.yellow,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.lightYellow)
    case .deepTealBlue: return .init(
        dayBackgrond: UIColor.KoyomiColor.tealBlue,
        weekBackgrond: UIColor.KoyomiColor.tealBlue,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.blue)
    case .deepBlue: return .init(
        dayBackgrond: UIColor.KoyomiColor.blue,
        weekBackgrond: UIColor.KoyomiColor.blue,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.tealBlue)
    case .deepPurple: return .init(
        dayBackgrond: UIColor.KoyomiColor.purple,
        weekBackgrond: UIColor.KoyomiColor.purple,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.lightPurple)
    case .deepGreen: return .init(
        dayBackgrond: UIColor.KoyomiColor.green,
        weekBackgrond: UIColor.KoyomiColor.green,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.lightGreen)
    case .deepPink: return .init(
        dayBackgrond: UIColor.KoyomiColor.pink,
        weekBackgrond: UIColor.KoyomiColor.pink,
        week: .white,
        weekday: .white,
        holiday: (.white, .white),
        otherMonth: UIColor.KoyomiColor.lightGray,
        separator: UIColor.KoyomiColor.lightPink)

    // Custom color style
    case .custom(let customColor): return .init(
        dayBackgrond: customColor.dayBackgrond,
        weekBackgrond: customColor.weekBackgrond,
        week: customColor.week,
        weekday: customColor.weekday,
        holiday: customColor.holiday,
        otherMonth: customColor.otherMonth,
        separator: customColor.separator)
    }
  }
}
...
public enum SelectionMode {
  case single(style: Style)
  case multiple(style: Style)
  case sequence(style: SequenceStyle)
  case none
...
@IBDesignable
public final class Koyomi: UICollectionView {
  struct Colors {
    ...
    init(
      dayBackgrond: UIColor,
      weekBackgrond: UIColor,
      week: UIColor = UIColor.KoyomiColor.black,
      weekday: UIColor = UIColor.KoyomiColor.black,
      holiday: (saturday: UIColor, sunday: UIColor) = (UIColor.KoyomiColor.blue, UIColor.KoyomiColor.red),
      otherMonth: UIColor = UIColor.KoyomiColor.lightGray,
      separator: UIColor = UIColor.KoyomiColor.lightGray)
    {
  ...
  @IBInspectable public var currentDateFormat = "yyyy/M"
  ...
  @IBInspectable public var selectedStyleColor = UIColor.KoyomiColor.red
  ...
  lazy var model: DateModel = .init()
  fileprivate let sectionSeparator: UIView = .init()

  fileprivate var layout: UICollectionViewLayout {
    KoyomiLayout(inset: inset, cellSpace: cellSpace, sectionSpace: sectionSpace, weekCellHeight: weekCellHeight)
  }
  ...
  public init(
    frame: CGRect,
    sectionSpace: CGFloat = 1.5,
    cellSpace: CGFloat = 0.5,
    inset: UIEdgeInsets = .zero,
    weekCellHeight: CGFloat = 25)
  {
    super.init(
      frame: frame,
      collectionViewLayout: KoyomiLayout(
        inset: inset,
        cellSpace: cellSpace,
  ...
  public func currentDateString(withFormat format: String = "yyyy/M") -> String {
    model.dateString(in: .current, withFormat: format)
  }
  ...
  override public func layoutSubviews() {
    ...
    sectionSeparator.frame = CGRect(
      x: inset.left,
      y: inset.top + weekCellHeight,
      width: frame.width - (inset.top + inset.left),
      height: sectionSpace)
  }
}
...
extension Koyomi {
  ...
  private func configure(_ cell: KoyomiCell, at indexPath: IndexPath) {
    ...
    if indexPath.section == 0 {
      ...
      style = {
        ...
        case (.multiple(style: .line), true),
             (.single(style: .line), true):
    ...
    if model.currentDates[indexPath.row] > currentDate {
      cell.xLabel.text = "x"
    }
    else {
      cell.xLabel.text = ""
      ...
      if isSelected {
        ...
        if cell.xLabel.text != "" {
          ...
          if indexPath.section == 0 {
            ...
            if
              let begin = model.indexAtBeginning(in: .current),
              let end = model.indexAtEnd(in: .current), (begin...end).contains(indexPath.row)
            {
    ...
    cell.configureAppearanse(
      of: style,
      withColor: selectionColor,
...
extension Koyomi: UICollectionViewDelegate {
  public func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
    selectionMode = .single(style: .circle)
...
extension Koyomi: UICollectionViewDataSource {
  ...
  public func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
    section == 0 ? DateModel.dayCountPerRow : DateModel.maxCellCount
  }

  public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    guard
      let cell = collectionView
        .dequeueReusableCell(withReuseIdentifier: KoyomiCell.identifier, for: indexPath) as? KoyomiCell
    else {
      return .init()
    }
