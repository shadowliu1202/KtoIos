...
///
/// To receive hub connection lifecycle event notifications create a class that conforms to this protocol and register it using
/// the `HubConnectionBuilder.withHubConnectionDelegate()` method.
///
