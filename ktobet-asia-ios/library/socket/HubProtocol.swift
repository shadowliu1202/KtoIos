...
public class ClientInvocationMessage: HubMessage, Decodable {
  ...
  public func getArgument<T: Decodable>(type _: T.Type) throws -> T {
...
public class StreamItemMessage: HubMessage, Decodable {
  ...
  public func getItem<T: Decodable>(_: T.Type) throws -> T {
    do {
...
public class CompletionMessage: HubMessage, Decodable {
  ...
  public func getResult<T: Decodable>(_: T.Type) throws -> T? {
    if hasResult {
      do {
