...
class NumberGameApi: ApiService, WebGameApi {
  ...
  func getMyBetGameGroupByDate(
    date: String,
    offset: Int = 8,
    myBetType: Int32,
    skip: Int = 0,
    take: Int = 100) -> Single<ResponseData<GameGroupBetSummaryResponse>>
  {
  ...
  func getMyGameBetInDuration(
    begindate: String,
    endDate: String,
    gameId: Int32,
    myBetType: Int32) -> Single<ResponseData<[BetSummaryDataResponse]>>
  {
  ...
  func getMyGameBetInDuration(
    ...
    myBetType: Int32,
    skip: Int = 0,
    take: Int = 100) -> Single<ResponseData<BetsSummaryResponse>>
  {
  ...
  func searchGames(
    ...
    isNew: Bool = false,
    map: [String: String]) -> Single<ResponseData<[NumberGameEntity]>>
  {
  ...
  func getNumberGameTagsWithCount() -> Single<String> {
