...
private extension CasinoDetailViewController {
  
  func createResultView(gameResult: CasinoGameResult) {
    if
  ...
  func createTwoSideThreeCardsResultView(gameResult: CasinoGameResult) {
    let spacing: CGFloat
  ...
  func createRowPokerCardsResultView(gameResult: CasinoGameResult) {
    let stackView = UIStackView(
      spacing: 16,
      axis: .vertical,
  ...
  func createBullFightResultView(
  ...
  func createN2BlackJackResultView(
  ...
  func createRouletteResultView(gameResult: CasinoGameResult.Roulette) {
    let label = UILabel()
  ...
  func createSicboResultView(gameResult: CasinoGameResult.Sicbo) {
    let stackView = UIStackView(
...
private extension CasinoDetailViewController {
  ...
  func createOneRowOfN2BlackJackResultView(
  ...
  func addPokerCard(pokerCardNumber: String, pokerCardSuit: PokerSuits) -> UIView {
  ...
  func createOneRowOfPokerCards(pokerCards: [PokerCard], title: String) -> UIView {
  ...
  func setPokerNumber(pokerNumber: PokerNumber) -> String {
    switch pokerNumber {
    case .ace:
      return "A"
    case .two:
  ...
  func setPokerCardSuit(pokerCardSuit: PokerSuits) -> UIImage? {
  ...
  func setDiceNumber(diceNumber: DiceNumber) -> UIImage? {
    switch diceNumber {
    case .one:
