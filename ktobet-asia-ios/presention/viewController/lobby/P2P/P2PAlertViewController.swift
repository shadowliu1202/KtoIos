  ...
  override func viewDidLoad() {
    ...
    if let turnOver = p2pTurnOver as? P2PTurnOver.TurnOverReceipt {
      headerLabel.text = String(
        format: Localize.string("product_p2p_turnover_description"),
        turnOver.turnOverDetail.informPlayerDate.toDateTimeString())
      ...
      percentageTitleLabel.text = String(
        ...
        turnOver.turnOverDetail.parameters.percentage.description())

      let spb = SegmentedProgressBar(
        numberOfSegments: 40,
        percentage: turnOver.turnOverDetail.parameters.percentage.percent)
