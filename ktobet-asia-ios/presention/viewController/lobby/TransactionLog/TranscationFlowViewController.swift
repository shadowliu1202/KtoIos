...
class TranscationFlowController {
    ...
    func goNext(_ transactionLog: TransactionLog) {
        ...
        case is TransactionLog.GameBonus, is TransactionLog.Log:
    ...
    private func goTransactionLogDetail(_ param: LogDetail) {
        guard let detailViewController = UIStoryboard(name: "TransactionLog", bundle: nil).instantiateViewController(withIdentifier: "TransactionLogDetailViewController") as? TransactionLogDetailViewController else { return }
    ...
    private func goCasinoDetail(_ wagerId: String) {
        guard let detail = UIStoryboard(name: "Casino", bundle: nil).instantiateViewController(withIdentifier: "CasinoDetailViewController") as? CasinoDetailViewController else { return }
