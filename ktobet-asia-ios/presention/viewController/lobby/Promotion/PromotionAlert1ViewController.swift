...
class PromotionAlert1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        headerLabel.text = String(format: Localize.string("bonus_turnover_confirm_title"), turnOver.informPlayerDate.toDateFormatString())
        ...
        percentageTitleLabel.text = String(format: Localize.string("bonus_current_completion"), turnOver.parameters.percentage.description())
