...
class WithdrawalCryptoRequestViewController: LobbyViewController, NotifyRateChanged {
    ...
    if limits.hasCryptoRequirement() {
      ...
      case .NotAllowed:
        fillAmounts(
          ...
          cryptoAmount: "0.0".toCryptoCurrency(supportCryptoType: cryptoType))
  ...
  private func filledCryptoRequestByBalance(
    cryptoTurnover: AccountCurrency,
...
class ExchangeRateView: UIView {
  ...
  func setup(
    ...
    _ cryptoExchangeRate: IExchangeRate,
    _ fiatCurrency: AccountCurrency,
    _ cryptoNetworkName: String)
  {
...
class CurrencyView: UIView {
  ...
  func currencyFormat(_: Decimal) -> String {
