...
class WithdrawalAssembly: Assembly {
  func assemble(container: Container) {
    ...
    container.autoregister(WithdrawalCryptoRecordDetailViewModel.self, initializer: WithdrawalCryptoRecordDetailViewModel.init)
    ...
    container.autoregister(WithdrawalCryptoWalletDetailViewModel.self, initializer: WithdrawalCryptoWalletDetailViewModel.init)
    container.autoregister(WithdrawalCreateCryptoAccountViewModel.self, initializer: WithdrawalCreateCryptoAccountViewModel.init)
    ...
    container.autoregister(WithdrawalCryptoRequestStep1ViewModel.self, initializer: WithdrawalCryptoRequestStep1ViewModel.init)
    container.autoregister(WithdrawalCryptoRequestStep2ViewModel.self, initializer: WithdrawalCryptoRequestStep2ViewModel.init)
