        ...
        PageContainer {
          VStack(spacing: 24) {
            ...
            Text(
              ...
              .localized(weight: .medium, size: 14, color: .orangeFF8000)
              .onTapGesture {
        ...
        if let requestInfo = viewModel.requestInfo {
          VStack(alignment: .leading, spacing: 6) {
            VStack(spacing: 16) {
              ...
              Separator(color: .gray9B9B9B, lineWeight: 0.5)
            ...
            .padding(.all, 16)
            .strokeBorder(color: viewModel.inputErrorText.isEmpty ? .gray9B9B9B : .orangeFF8000, cornerRadius: 6)
      ...
      HStack(spacing: 16) {
        ...
        UIKitTextField(
          ...
          updateConfiguration: { uiTextField in
            uiTextField.textColor = isEditing ? .whitePure : .gray9B9B9B
          })
          .onTapGesture {
            isEditing = true
          }
