...
extension HubConnection {
  ...
  ///
  /// The `invoke` method invokes a server side hub method and returns the status of the invocation. The `error` parameter of the
  /// `invocationDidComplete` callback will be `nil` if the invocation was successful. Otherwise it will contain failue details.
  /// Note that the failure can be local - e.g. the invocation was not initiated successfully (for example the connection was not
  /// connected when invoking the method), or remote - e.g. the hub method on the server side threw an exception.
  ///
  ...
  /// - parameter error: contains failure details if the invocation was not initiated successfully or the hub method threw an
  /// exception. `nil` otherwise
  ...
  /// - parameter error: contains failure details if the invocation was not initiated successfully or the hub method threw an
  /// exception. `nil` otherwise
  public func invoke(method: String, _ arg1: some Encodable, invocationDidComplete: @escaping (_ error: Error?) -> Void) {
  ...
  public func invoke(
    method: String,
    _ arg1: some Encodable,
    _ arg2: some Encodable,
  ...
  ///
  /// The `invoke` method invokes a server side hub method and returns the result of the invocation or error. If the server side
  /// method completed successfully the `invocationDidComplete` callback will be called with the result returned by the method and
  /// `nil` error. Otherwise the `error` parameter of the `invocationDidComplete` callback will contain failure details. Note that
  /// the failure can be local - e.g. the invocation was not initiated successfully (for example the connection was not started
  /// when invoking the method), or remote - e.g. the hub method threw an error.
  ///
  /// - parameter method: the name of the server side hub method to invoke
  ...
  ///
  /// When a hub method is invoked in a fire-and-forget manner the client never receives any result of the invocation nor is
  /// notified about the invocation status.
  ///
  /// - parameter method: the name of the server side hub method to invoke
  /// - parameter sendDidComplete: a completion handler that allows to track whether the client was able to successfully initiate
  /// the invocation. If the invocation was successfully initiated the `error` will be `nil`. Otherwise the `error` will contain
  /// failure details
  ...
  /// failure details
  /// - parameter error: contains failure details if the invocation was not initiated successfully. `nil` otherwise
  public func send(method: String, _ arg1: some Encodable, sendDidComplete: @escaping (_ error: Error?) -> Void = { _ in }) {
  ...
  public func on(method: String, callback: @escaping () -> Void) {
    let cb: (ArgumentExtractor) throws -> Void = { _ in
      callback()
    }
  ...
  public func on<T1: Decodable, T2: Decodable, T3: Decodable>(
    method: String,
    callback: @escaping (_ arg1: T1, _ arg2: T2, _ arg3: T3) -> Void)
  {
    let cb: (ArgumentExtractor) throws -> Void = { argumentExtractor in
      let arg1 = try argumentExtractor.getArgument(type: T1.self)
      let arg2 = try argumentExtractor.getArgument(type: T2.self)
  ...
  public func on<T1: Decodable, T2: Decodable, T3: Decodable, T4: Decodable>(
    method: String,
    callback: @escaping (_ arg1: T1, _ arg2: T2, _ arg3: T3, _ arg4: T4) -> Void)
  {
    let cb: (ArgumentExtractor) throws -> Void = { argumentExtractor in
      let arg1 = try argumentExtractor.getArgument(type: T1.self)
      let arg2 = try argumentExtractor.getArgument(type: T2.self)
  ...
  public func on<T1: Decodable, T2: Decodable, T3: Decodable, T4: Decodable, T5: Decodable>(
    method: String,
    callback: @escaping (_ arg1: T1, _ arg2: T2, _ arg3: T3, _ arg4: T4, _ arg5: T5) -> Void)
  {
    let cb: (ArgumentExtractor) throws -> Void = { argumentExtractor in
      let arg1 = try argumentExtractor.getArgument(type: T1.self)
      let arg2 = try argumentExtractor.getArgument(type: T2.self)
  ...
  /// }
  /// ```
  public func on<T1: Decodable, T2: Decodable, T3: Decodable, T4: Decodable, T5: Decodable, T6: Decodable, T7: Decodable>(
    method: String,
  ...
  >(
    method: String,
    callback: @escaping (_ arg1: T1, _ arg2: T2, _ arg3: T3, _ arg4: T4, _ arg5: T5, _ arg6: T6, _ arg7: T7, _ arg8: T8)
      -> Void)
  {
    let cb: (ArgumentExtractor) throws -> Void = { argumentExtractor in
      let arg1 = try argumentExtractor.getArgument(type: T1.self)
  ...
  /// - parameter arg7: seventh argument of the client side hub method
  /// - parameter arg8: eighth argument of the client side hub method
  /// - parameter arg9: ninth argument of the client side hub method
  /// - parameter arg10: tenth argument of the client side hub method
  /// - note: the callback parameters may need to be typed if the types cannot be inferred e.g.:
  /// ```
  /// hubConnection.on(method: "AddMessage") {(user: String, message: String) in
  ///   print(">>> \(user): \(message)")
  ...
  /// - `invocationDidComplete` - invoked when the invocation of the streaming method has completed. If the streaming method
  /// completed successfully or was cancelled the callback will be called with `nil` error. Otherwise the `error` parameter of the
  /// `invocationDidComplete` callback will contain failure details. Note that the failure can be local - e.g. the invocation was
  /// not initiated successfully (for example the connection was not started when invoking the method), or remote - e.g. the hub
  ...
  /// ```
  /// hubConnection.stream(method: "StreamNumbers", 10, 1, streamItemReceived: { (item: Int) in print("\(item)" }) { error in
  /// print("\(error)") }
  /// ```
