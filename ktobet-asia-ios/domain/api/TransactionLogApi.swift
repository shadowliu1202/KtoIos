...
class TransactionLogApi: ApiService {
  ...
  func searchBalanceLogs(
    begin: String,
    end: String,
    balanceLogFilterType: Int,
    page: Int = 1,
    isDesc: Bool = true) -> Single<ResponseData<PayloadPage<BalanceDateLogBean>>>
  {
  ...
  func getIncomeOutcomeAmount(
    ...
    balanceLogFilterType: Int) -> Single<ResponseData<IncomeOutcomeBean>>
  {
