            ...
            let notifications = try data.documents.map { internalMessageBean -> SharedBu.Notification? in
                ...
                case 0:
                    return SharedBu.Notification.Maintenance(messageId: internalMessageBean.messageId,
                                                             ...
                                                             displayTime: try internalMessageBean.showTime?.toOffsetDateTime() ?? OffsetDateTime.companion.NotDefine,
                                                             maintenanceStart: try internalMessageBean.maintenanceStartTime.toShareOffsetDateTime(),
                                                             maintenanceEnd: try internalMessageBean.maintenanceEndTime.toShareOffsetDateTime())
                case 1:
